        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <div className="prose prose-invert max-w-none space-y-12 text-[#9a9aad] text-sm leading-relaxed">
            ...
            <section>
              ...
              <p>Third-party services utilized in connection with ZEF Events may include but are not limited to game publishers&apos; platforms (Riot Games, Supercell, Krafton, Garena, The Pokémon Company), streaming platforms (YouTube, Twitch), social media platforms (Instagram, Twitter/X, Discord), and payment processors. Your use of such third-party services is governed by their respective terms of service and privacy policies.</p>
            </section>
